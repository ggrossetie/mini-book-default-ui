= Mini Book Default UI
// Settings:
:experimental:
:hide-uri-scheme:
// Project URLs:
:url-project: https://github.com/Mogztter/mini-book-default-ui
// External URLs:
...
If you want to simply use this UI for your Antora-generated site, add the following UI configuration to your playbook:
